The `multi_dataset` folder contains example scripts showing how to perform analysis combining multiple datasets, for example:
...
each example before using the `multi_dataset` functionality.
