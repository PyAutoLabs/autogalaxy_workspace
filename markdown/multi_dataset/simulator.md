> ✏️ **This page is auto-generated from [`scripts/multi_dataset/simulator.py`](../../scripts/multi_dataset/simulator.py) — do not edit it directly.**
> It shows the example fully executed, with its real output images.
> Run it yourself via the [Python script](../../scripts/multi_dataset/simulator.py) or the [Jupyter notebook](../../notebooks/multi_dataset/simulator.ipynb).
...
![png](simulator_files/simulator_17_1.png)
...
The dataset can be viewed in the folder `autogalaxy_workspace/dataset/multi_dataset/imaging/simple`.
