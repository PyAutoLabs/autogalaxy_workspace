> ✏️ **This page is auto-generated from [`scripts/multi_dataset/modeling.py`](../../scripts/multi_dataset/modeling.py) — do not edit it directly.**
> It shows the example fully executed, with its real output images.
> Run it yourself via the [Python script](../../scripts/multi_dataset/modeling.py) or the [Jupyter notebook](../../notebooks/multi_dataset/modeling.ipynb).
...
```python
search = af.Nautilus(
    path_prefix=Path("multi_dataset") / "features",
    name="start_here",
...
The `multi_dataset/features` package has more examples of how to fit multiple datasets with different models,
