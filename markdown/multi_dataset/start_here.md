> ✏️ **This page is auto-generated from [`scripts/multi_dataset/start_here.py`](../../scripts/multi_dataset/start_here.py) — do not edit it directly.**
> It shows the example fully executed, with its real output images.
> Run it yourself via the [Python script](../../scripts/multi_dataset/start_here.py) or the [Jupyter notebook](../../notebooks/multi_dataset/start_here.ipynb).
...
- `autogalaxy_workspace/*/multi_dataset/features`: A full description of the multi wavelength and multi image fitting.
