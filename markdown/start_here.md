...
![png](start_here_files/start_here_13_0.png)
...
![png](start_here_files/start_here_17_0.png)
...
- [imaging/start_here.ipynb](https://colab.research.google.com/github/PyAutoLabs/autogalaxy_workspace/blob/2026.9.26.1/notebooks/imaging/start_here.ipynb>):
  Galaxy modeling with CCD imaging (e.g. Hubble, James Webb, ground-based telescopes).

- [interferometer/start_here.ipynb](https://colab.research.google.com/github/PyAutoLabs/autogalaxy_workspace/blob/2026.9.26.1/notebooks/interferometer/start_here.ipynb):
  Galaxy modeling with interferometer data (e.g. ALMA), fitting directly in the uv-plane.

- [multi_band/start_here.ipynb](https://colab.research.google.com/github/PyAutoLabs/autogalaxy_workspace/blob/2026.9.26.1/notebooks/multi_dataset/start_here.ipynb):
...
The [PyAutoGalaxy AI Assistant](https://github.com/PyAutoLabs/autogalaxy_assistant) lets you do galaxy structure and
morphology science in natural language from inside an AI coding agent. You can get started simply by asking it a
question about galaxy structure or describing the task you would like to perform with **PyAutoGalaxy**. See the
assistant for its full scope and instructions.
