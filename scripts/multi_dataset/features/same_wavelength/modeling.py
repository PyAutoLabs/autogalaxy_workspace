...
modelled in the analysis. The example `multi_dataset/features/dataset_offsets/modeling.py` demonstrates how to do this.
...
if ag.util.dataset.should_simulate(str(dataset_path)):
    ...
    subprocess.run(
        [sys.executable, "scripts/multi_dataset/features/same_wavelength/simulator.py"],
        check=True,
    )
