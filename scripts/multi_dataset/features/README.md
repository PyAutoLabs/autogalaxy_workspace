The `multi_dataset/features` folder contains example scripts showing how to analyse multiple datasets simultaneously.
...
The `multi_dataset` package extends the `imaging` package and readers should refer to the `imaging` package for
