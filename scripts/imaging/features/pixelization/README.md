...
- `source_reconstruction`: How to output a source reconstruction from a pixelized source model fit. to a .csv which can be loaded to analyse the source without autogalaxy.
